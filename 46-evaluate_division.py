...
# Time Complexity: O(E+Q⋅V) where E is the number of equations (or edges), as we add each equation to the graph once, Q is the number of queries and V is the number of variables (nodes).
# Space Complexity: O(E+V+Q) 